...
(function($, undefined) {
    ...
    $.extend($.tmpl, {
        ...
        complete: function(items) {
            ...
            var items2 = $.extend({},items[Object.keys(items)[0]],true);
            
//            console.log(items2.nodes);
//            console.log(items2.data);
            
            $(items2.nodes).parent().find("[tmplData]").each(function(_idx, _value){

                var key = $(_value).attr("tmplData");
                if(key != null){
                    key = key.replace("$item","items2.data");
                    try{
                        if(eval(key) instanceof Object){
                            $(_value).data("tmplData",eval(key));
                        }
                    }
                    catch(e){}
                    
                    $(_value).removeAttr("tmplData");
                }
            });
    ...
    function storeTmplItems(content) {
        ...
        function processItemKey(el) {
            ...
            if(tmplItem) {
                ...
                $.data(el, "tmplItem2", tmplItem.data);
            }
